...
#define SIZE_acpi_device_id 28 /* sizeof(struct acpi_device_id) */
#define OFF_acpi_device_id_id 0 /* offsetof(struct acpi_device_id, id) */
#define OFF_acpi_device_id_cls 20 /* offsetof(struct acpi_device_id, cls) */
#define OFF_acpi_device_id_cls_msk 24 /* offsetof(struct acpi_device_id, cls_msk) */
...
#define SIZE_ishtp_device_id 20 /* sizeof(struct ishtp_device_id) */
